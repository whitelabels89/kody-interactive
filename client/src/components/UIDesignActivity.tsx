  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl">Pilih Tombol Kontrol (Maksimal 3):</CardTitle>
          ...
          <CardContent className="space-y-3">
            {controlButtons.map((button) => {
              ...
              const canSelect = selectedButtons.length < 3 || isSelected;
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-gray-900 rounded-2xl p-6 min-h-[200px]">
              <div className="text-center mb-4">
                <h4 className="text-white font-semibold mb-2">Kontrol Kody</h4>
                ...
                {selectedButtons.map((buttonId) => {
                  ...
                  return (
                    <Button
                      ...
                      className={`${button.color} hover:opacity-80 text-white font-semibold py-3 rounded-xl transition-all duration-200 ${
              ...
              {selectedButtons.length === 0 && (
                <div className="text-center text-gray-400 py-8">
                  Pilih tombol dari daftar di sebelah kiri
                </div>
              )}
            </div>
